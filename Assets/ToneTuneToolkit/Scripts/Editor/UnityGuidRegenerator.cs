...
namespace ToneTuneToolkit
{
    ...
    {
        private static string customPath = "Assets/AR/Textures/Reroll";

        [MenuItem("Tools/TTT/RegenerateAssetGUIDs")]
        public static void RegenerateGuids()
        {
                ...
                "OK", "Cancel"))
            {
                try
                {
                    ...
                    string path = Path.GetFullPath(".") + Path.DirectorySeparatorChar + customPath; // 要更新guid的文件夹
